jQuery(document).ready(function($){
    ...
    wacChange = function(element) {
        ...
        $("input[name='update_cart']").val(wooajaxcart_localization.updating_text).prop('disabled', true);
        $("a.checkout-button.wc-forward").addClass('disabled').html(wooajaxcart_localization.updating_text);
