	...
	class YITH_WACP_Frontend_Premium extends YITH_WACP_Frontend {
		...
		public function add_actions_button( $product) {
			...
			<div class="popup-actions">
				...
				<?php endif ?>
				<?php if( $continue ) : ?>
					<a href="#" class="<?php echo apply_filters( 'yith_wacp_continue_shopping_class', 'button continue-shopping' ) ?>" href=""><?php echo get_option( 'yith-wacp-text-continue-shopping', '' ) ?></a>
				<?php endif; ?>
			</div>
