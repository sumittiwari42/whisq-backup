...
function Insert_Customer_Order_Form($atts) {
	...
	extract( shortcode_atts( array(
				...
				'customer_name_field_text' => __('Order Name', 'order-tracking'),
				'customer_email_field_text' => __('Order E-mail Address', 'order-tracking'),
				'customer_notes_field_text' => __('Customer Notes', 'order-tracking'),
