...
<?php endif; ?>
		...
		<h2><?php _e( 'Welcome to whisq', 'woocommerce' ); ?></h2>
...
<!--  <div class="captcha-block">
      ...
      <input type="hidden" class="hiddenRecaptcha required" name="hiddenRecaptcha" id="hiddenRecaptcha">
			...
			<p class="form-row text-center">
				...
				<input type="submit" class="woocommerce-Button button feature-btn" name="login" value="<?php esc_attr_e( 'Log In', 'woocommerce' ); ?>" />
			</p>

			<p class="re-log">New to whisq? <span><a href="<?php echo esc_url( home_url( '/sign-up/' ) ); ?>">Create Account</a></span></p>
