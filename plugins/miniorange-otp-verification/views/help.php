...
echo'	<table width="100%">
		<tbody>
		 	<tr><td>
		 		<p>'.__("If any section is not opening, press CTRL + F5 to clear cache.",'wp-otp-verification').'<p>
		 		<div class="registration_question"><h3><a>'.__("How does this plugin work?",'wp-otp-verification').'</a></h3></div>
		 		<div hidden  class="mo_registration_help_desc">
					<ol>
						<li>'.__("On submitting the registration form an Email/SMS with OTP is sent to the email address/mobile number 
							 provided by the user.",'wp-otp-verification').'</li>
						<li>'.__("Once the OTP is entered, it is verified by our servers.",'wp-otp-verification').'</li>
					</ol>
				</div>
				<hr>
			</td></tr>
			...
			<tr><td>
				<div class="registration_question">
					<h3><a>'.__("My Registration form is missing from the list",'wp-otp-verification').'</a></h3>
				</div>
				<div  hidden  class="mo_registration_help_desc">
					'.__("We are actively adding support for more forms. Please contact us using the support form on your right or email us at 
							...
							and how you intend to use this plugin. We will respond promptly.",'wp-otp-verification').'
				</div>
				<hr>
			</td></tr>
			<tr><td>
				<div class="registration_question">
					<h3><a>'.__("Is OTP SMS delivered to DND(Do Not Disturb) mobile numbers?",'wp-otp-verification').'</a></h3>
				</div>
				<div hidden class="mo_registration_help_desc">
					'.__("Yes, OTP SMS is even delivered to DND mobile numbers.",'wp-otp-verification').'
				</div>
				<hr>
			</td></tr>
			<tr><td>
				<div class="registration_question">
					<h3><a>'.__("Is SMS OTP delivered in any part of the world?",'wp-otp-verification').'</a></h3>
				</div>
				<div hidden class="mo_registration_help_desc">
					'.__("Yes, miniOrange SMS gateway delivers SMS all over the world but the pricing on 
							SMS delivery defers from country to country.",'wp-otp-verification').'
				</div>
				<hr>
			</td></tr>
		 	...
		 	<tr><td>
				<div class="registration_question">
					<h3><a>'.__("How do i integrate the plugin with my own custom Registration Form?",'wp-otp-verification').'</a></h3></div>
				<div  hidden  class="mo_registration_help_desc">
					'.__("Please contact us using the support form on your right or email us at <b>info@miniorange.com</b>. 
						...
						this plugin. We will respond promptly.",'wp-otp-verification').'
				</div>
				<hr>
		 	</td></tr>
		 	<tr><td>
				<div class="registration_question">
					<h3><a>'.__("How to enable PHP cURL extension? (Pre-requisite)",'wp-otp-verification').'</a></h3>
				</div>
				<div hidden  class="mo_registration_help_desc">
					'.__("cURL is enabled by default but in case you have disabled it, follow the steps to enable it",'wp-otp-verification').'
					<ol>
						<li>'.__("Open php.ini(it's usually in /etc/ or in php folder on the server).",'wp-otp-verification').'</li>
						<li>'.__("Search for extension=php_curl.dll. Uncomment it by removing the semi-colon( ; ) in front of it.",
							'wp-otp-verification').'</li>
						<li>'.__("Restart the Apache Server.",'wp-otp-verification').'</li>
					</ol>
			...
			<tr><td>
				<div class="registration_question">
					<h3><a>'.__("I am getting this error. What do i do?",'wp-otp-verification').'
				<span style="font-size:12px;">
					<br/>'.__("[ curl_setopt(): CURLOPT_FOLLOWLOCATION cannot be activated when an open_basedir is set. ]"
						,'wp-otp-verification').'</a></span></h3></div>
				<div hidden class="mo_registration_help_desc">
					'.__("Just set safe_mode = Off in your php.ini file (it's usually in /etc/ on the server). If that's already off, 
						then look around for the open_basedir in the php.ini file, and change it to open_basedir = .",'wp-otp-verification').'
				</div>
				<hr>
			</td></tr>
		 	...
		 	<tr><td>
				<div class="registration_question">
					<h3><a>'.__("I did not recieve OTP. What should I do?",'wp-otp-verification').'</a></h3>
				</div>
				<div hidden class="mo_registration_help_desc">
					'.__("The OTP is sent as an email to your email address with which you have registered. 
							...
							please contact us using the Support form on the right.",'wp-otp-verification').'
				</div>
				<hr>
			</td></tr>
			<tr><td>
				<div class="registration_question">
					<h3><a>'.__("After entering OTP, I get Invalid OTP. What should I do?",'wp-otp-verification').'</a></h3>
				</div>
				<div hidden class="mo_registration_help_desc">
					'.__("Use the <b>Resend OTP</b> option to get an additional OTP. 
							...
							contact us using the Support form on the right.",'wp-otp-verification').'
				</div>
				<hr>
			</td></tr>
			<tr><td>
				<div class="registration_question">
					<h3><a>'.__("I forgot the password of my miniOrange account. How can I reset it?",'wp-otp-verification').'</a></h3>
				</div>
				<div hidden class="mo_registration_help_desc">
					'.__("There are two cases according to the page you see -",'wp-otp-verification').'<br><br/>
			...
			<tr><td>
				<div class="registration_question">
					<h3><a>'.__("How is this plugin better than other plugins available?",'wp-otp-verification').'</a></h3>
				</div>
				<div hidden class="mo_registration_help_desc">
					<ol>
						<li>'.__("Verification of user's Email Address/Mobile Number during registration is a must these days. 
								...
								own SMTP/SMS gateway. You can use our own gateways to send OTP over Email/SMS.",'wp-otp-verification').'</li>
						<li>'.__("You can even use your own SMS/SMTP Gateway if you choose to do so.",'wp-otp-verification').'</li>
						<li>'.__("Each Email is verified for it's authenticity by miniOrange servers.",'wp-otp-verification').'</li>
						<li>'.__("Easy and hassle free setup. No SMTP/SMS gateway configuration required. 
									You just need to choose your registration form and you are good to go.",'wp-otp-verification').'</li>
						<li>'.__("Customizable Email/SMS Templates.",'wp-otp-verification').'</li>
					</ol>
				</div>
				<hr>
			</td></tr>
