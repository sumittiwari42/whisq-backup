...
echo'	<form name="f" method="post" action="">
			...
			<div class="mo_registration_divided_layout">
				<div class="mo_registration_table_layout">
					<h3>'.__("Login with miniOrange",'wp-otp-verification').'</h3>
					<p><b>'.__("It seems you already have an account with miniOrange. Please enter your miniOrange email and password.",'wp-otp-verification').'</td><a href="#forgot_password"> '.__("Click here if you forgot your password?",'wp-otp-verification').'</a></b></p>
					<table class="mo_registration_settings_table">
						...
						<tr>
							...
							<td><input class="mo_registration_table_textbox" required type="password"
								name="password" placeholder="'.__("Enter your miniOrange password",'wp-otp-verification').'" /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
