...
class MoUtility
{
	...
	{
		$message = get_option("mo_otp_invalid_message") ? _x(get_option("mo_otp_invalid_message"),null,'wp-otp-verification') 
													: _x(MoMessages::showMessage('INVALID_OTP'),null,'wp-otp-verification');
		return self::_is_polylang_installed() ? pll__($message) : $message;
	}
