<?php
	...
	class WpEmemberForm extends FormInterface
	{
		...
		function handleForm()
		{
			$this->otpType = get_option('mo_customer_validation_emember_enable_type');
		...
		{
			return get_option('mo_customer_validation_emember_default_enable') ? TRUE : FALSE;
		}
		...
		function handleFormOptions()
		{
			...
			update_option('mo_customer_validation_emember_default_enable',
				isset( $_POST['mo_customer_validation_emember_default_enable']) ? $_POST['mo_customer_validation_emember_default_enable'] : 0);
			update_option('mo_customer_validation_emember_enable_type',
