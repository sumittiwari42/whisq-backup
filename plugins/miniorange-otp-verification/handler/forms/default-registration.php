<?php
	...
	class DefaultWordPressRegistrationForm extends FormInterface
	{
		...
		{
			return get_option('mo_customer_validation_wp_reg_restrict_duplicates') ? true : false;
		}
		...
		{	
			...
			if( $this->isPhoneVerificationEnabled())
				echo '<label for="phone_number_mo">'.__("Phone Number",'wp-otp-verification').'<br />
		...
		function handleFormOptions()
		{
			...
			update_option('mo_customer_validation_wp_reg_restrict_duplicates',
