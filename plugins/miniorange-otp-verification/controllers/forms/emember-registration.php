...
//WP eMember
$emember_enabled 			  = get_option('mo_customer_validation_emember_default_enable') ? "checked" : "";
$emember_hidden 			  = $emember_enabled== "checked" ? "" : "hidden";
$emember_enable_type		  = get_option('mo_customer_validation_emember_enable_type');
