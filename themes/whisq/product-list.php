...
?>	
		<div class="whisqtitle">
			...
			<?php } else { ?>
              <p class="wrapper breadcrumb-url"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">Home</a> > <a href="<?php echo esc_url( home_url( '/bakeware/' ) ); ?>" rel="home">Products</a> > <span><?php the_title(); ?></span></p>
			<?php } ?>
		</div>
      <?php
