...
?>	
    	    ...
    	    <select name="select-city" id="cities" class="cities" >
    	        <option name"city" value="city">State</option>
    	    		<option name"city" value="city">all</option>
							...
							foreach ($tags as $tag){
							?>
								<option name="<?php echo $tag->slug; ?>" value="<?php echo $tag->slug; ?>"><?php echo $tag->name; ?></option>
							<?php
							}
              ?>
          </select>
    ...
    <div class="Foodhall-address addwrap">
		...
		<div class="BigBazaar-address addwrap">
		...
		<div class="button-link">
			<a href="<?php echo esc_url( home_url( '/bakeware/') ); ?>" title="buy our products online">buy our products online</a>
		</div>
